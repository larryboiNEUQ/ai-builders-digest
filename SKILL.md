...
1. **额度已经是产品体验的一部分，不是售后补丁。**  
   Sol 发布日连按两次 reset，评论区却仍在喊 5h 限流——说明发布周真正稀缺的是「跑得完 ambitious task 的配额」，不是权重本身。做 agent 产品的人，得把限流/reset 当成功能设计，而不是运维事故。  
   >> [@thsottiaux · 双 reset](https://x.com/...) · [@thsottiaux · full reset](https://x.com/...)

2. **……**  
   ……  
   >> [@handle · 主题](https://x.com/...)
```
